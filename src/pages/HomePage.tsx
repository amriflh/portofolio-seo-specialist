        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="flex flex-col items-center">
            ...
            <div className="relative flex justify-center mb-6">
              <div className="absolute w-[320px] sm:w-[350px] h-[320px] sm:h-[350px] bg-[#FFB800] rounded-[60%_40%_30%_70%_/_60%_30%_70%_40%]"></div>
              <div className="w-[280px] sm:w-[300px] h-[370px] sm:h-[400px] bg-slate-200 rounded-[80px] sm:rounded-[90px] overflow-hidden border-8 border-white relative z-10 flex items-center justify-center shadow-xl">
                <img 
            ...
            {/* Logo / Tombol Media Sosial di Bawah Gambar */}
            <div className="flex flex-wrap items-center justify-center gap-2.5 z-10 bg-[#1a352a]/80 p-2.5 rounded-2xl border border-white/10 backdrop-blur-sm shadow-lg">
              <a
                href="https://www.instagram.com/amridigital.ai/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-[#12261d] hover:bg-[#FFB800] text-white hover:text-[#2A4D3E] flex items-center justify-center border border-white/10 hover:border-[#FFB800] transition-all duration-300 shadow-sm group"
                title="Instagram"
              >
